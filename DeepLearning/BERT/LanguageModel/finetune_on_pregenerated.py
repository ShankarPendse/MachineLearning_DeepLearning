...
def main():
    ...
    tokenizer = BertTokenizer.from_pretrained('D:/Bert_Models/bert-base-uncased', do_lower_case=args.do_lower_case)
    ...
    # Prepare model
    model = BertForPreTraining.from_pretrained('D:/Bert_Models/bert-base-uncased')
