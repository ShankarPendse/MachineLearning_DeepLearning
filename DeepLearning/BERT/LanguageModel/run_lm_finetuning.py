    ...
    def __init__(self, tokenizer, file_path, block_size=512):
        ...
        if os.path.exists(cached_features_file):
            ...
            with open(file_path, encoding="utf-8") as f:
                text = f.read()
            print("displaying text read from above file: \n")
            print("\n",text)
...
def load_and_cache_examples(args, tokenizer, evaluate=False):
    print("inside load_and_cache_examples function\n")
    print("\n-----------------------------------------------------------\n")
    print("train_data_file: ",args.train_data_file)
...
def train(args, train_dataset, model, tokenizer):
    ...
    print("train_data_set: ",train_dataset)
...
def main():
    ...
    if args.do_train:
        ...
        print("checking while load_and_cache_examples call \n")
        print("\n args: ", args)
        print("\n-----------------------------------------------------------\n")
